...
.login-av{
  ...
  cursor:pointer;border:2px solid transparent;transition:all .25s;position:relative;
}
.login-av:hover{transform:scale(1.08)}
.login-av.sel{border-color:var(--accent);box-shadow:0 0 16px var(--card-glow)}
...
.login-field input{
  ...
  color:var(--text);font-size:.9rem;outline:none;transition:border .3s;
}
...
.sidebar{
  ...
  gap:2px;overflow-y:auto;z-index:10;
  transition:background .3s,border-color .3s;
}
.sidebar-icon{
  width:40px;height:40px;border-radius:10px;border:none;
  background:transparent;color:var(--text3);font-size:1.15rem;
...
/* ═══════════════════════════════════════════════
   HAMBURGER (mobile)
   ═══════════════════════════════════════════════ */
.hamburger{display:none;background:none;border:none;color:var(--text);font-size:1.3rem;padding:4px}
...
.topbar{
  ...
  background:rgba(255,255,255,.01);backdrop-filter:blur(20px);
  -webkit-backdrop-filter:blur(20px);flex-shrink:0;z-index:5;
  transition:background .3s,border-color .3s;
}
...
.topbar-avatar{
  ...
  display:flex;align-items:center;justify-content:center;
  font-family:var(--font-h);font-weight:700;font-size:.7rem;cursor:pointer;
}
.tb-btn{
...
.overview-card{
  ...
  transition:all .3s;contain:layout style;
}
.overview-card:hover{
  transform:translateY(-3px);border-color:rgba(255,255,255,.12);
  box-shadow:0 8px 32px rgba(0,0,0,.2),0 0 0 1px rgba(255,255,255,.05);
}
...
.team-card:hover{
  transform:translateY(-3px);border-color:rgba(185,255,102,.2);
  box-shadow:0 8px 32px rgba(0,0,0,.2),0 0 20px var(--card-glow);
}
...
.contact-item{
  ...
  background:var(--glass);border:1px solid var(--glass-border);
  border-radius:var(--radius-xs);transition:all .25s;cursor:pointer;
  position:relative;overflow:hidden;
  border-left:3px solid transparent;
}
.contact-item.status-pending{border-left-color:var(--text3)}
...
.contact-item:hover{
  ...
  box-shadow:0 2px 12px var(--card-glow);
}
...
/* Quick action buttons on contact item */
.ci-actions{display:flex;gap:4px;flex-shrink:0;opacity:0;transition:opacity .2s}
.contact-item:hover .ci-actions{opacity:1}
.ci-quick-btn{
  width:28px;height:28px;border-radius:6px;border:1px solid var(--glass-border);
  background:var(--glass);color:var(--text2);font-size:.7rem;
  display:flex;align-items:center;justify-content:center;transition:all .2s;
}
.ci-quick-btn:hover{border-color:var(--accent);color:var(--accent);transform:scale(1.1)}
.ci-quick-btn.done-btn:hover{border-color:var(--success);color:var(--success)}
.ci-quick-btn.sale-btn:hover{border-color:var(--success);color:var(--success)}

/* Sale / Demo badges */
.ci-badges{display:flex;gap:4px;margin-top:3px}
.ci-badge{font-size:.55rem;padding:1px 5px;border-radius:100px;font-weight:600}
.ci-badge.sale-yes{background:rgba(52,211,153,.12);color:#34d399}
.ci-badge.sale-no{background:rgba(255,62,108,.08);color:#ff3e6c}
.ci-badge.demo-yes{background:rgba(56,189,248,.1);color:#38bdf8}
...
.bento-card{
  background:var(--glass);border:1px solid var(--glass-border);
  border-radius:var(--radius-xs);padding:14px;transition:all .3s;
}
...
.form-field input,.form-field select,.form-field textarea{
  ...
  border:1px solid var(--glass-border);background:rgba(255,255,255,.03);
  color:var(--text);font-size:.82rem;outline:none;transition:border .3s;font-family:var(--font-b);
}
...
.btn-primary{
  ...
  background:var(--grad);color:#000;font-weight:700;font-size:.82rem;
...
.ai-close{
  ...
  background:var(--glass);color:var(--text3);font-size:.8rem;
  display:flex;align-items:center;justify-content:center;transition:all .2s;
}
...
.ai-msg .mt code{background:rgba(255,255,255,.05);padding:1px 4px;border-radius:3px;font-size